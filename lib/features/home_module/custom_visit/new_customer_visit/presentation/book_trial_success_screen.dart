...
class BookTrialSuccessScreen extends StatefulWidget {
  const BookTrialSuccessScreen({super.key});

  @override
  State<BookTrialSuccessScreen> createState() => _BookTrialSuccessScreenState();
}

class _BookTrialSuccessScreenState extends State<BookTrialSuccessScreen> {
  @override

...
import 'package:mohan_impex/features/home_module/custom_visit/visit_draft_details/presentation/visit_draft_details_screen.dart';
import 'package:mohan_impex/res/app_colors.dart';
import 'package:mohan_impex/res/app_router.dart';

class VisitDraftWidget extends StatelessWidget {
  const VisitDraftWidget({super.key});
  ...
  Widget build(BuildContext context) {
    return ListView.separated(
      ...
      itemBuilder: (ctx,index){
        return InkWell(
          onTap: (){
            AppRouter.pushCupertinoNavigation(const VisitDraftDetailsScreen());
          },
          child: Container(

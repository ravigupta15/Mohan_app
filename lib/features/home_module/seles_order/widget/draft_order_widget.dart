...
import 'package:mohan_impex/features/home_module/seles_order/presentation/view_draft_order_screen.dart';
import 'package:mohan_impex/res/app_colors.dart';
import 'package:mohan_impex/res/app_router.dart';

class DraftOrderWidget extends StatelessWidget {
  const DraftOrderWidget({super.key});
  ...
  Widget build(BuildContext context) {
    return ListView.separated(
      ...
      itemBuilder: (ctx,index){
        return InkWell(
          onTap: (){
            AppRouter.pushCupertinoNavigation(const ViewDraftOrderScreen());
          },
          child: Container(

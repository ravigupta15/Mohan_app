...
class _MyCustomerScreenState extends ConsumerState<MyCustomerScreen> {
  ...
  Widget selectedFiltersWidget({required MyCustomerNotifier refNotifier, required MyCustomerState refState}) {
                ...
                Padding(
                  ...
                  child: Column(
                      ...
                      child: Row(
                        ...
                        return Padding(
                          ...
                          child: customRadioButton(
                              isSelected:
                                  selectedBusinessTypeIndex == val ? true : false,
                    ...
                    SingleChildScrollView(
                      scrollDirection: Axis.horizontal,
                      child: Row(
                          children: List.generate(refNotifier.biilingList.length,
                              (val) {
                        return Padding(
                          padding: const EdgeInsets.symmetric(horizontal: 12),
                          child: customRadioButton(
                              isSelected:
                                  selectedBillingTypeIndex == val ? true : false,
                    ...
                    //     selectedDistrict = "";
                    //     filterState = val;
                    //     refState.districtModel = null;
                    //     refNotifier.districtApiFunction(context, stateText: filterState).then((val){
                    //       if(val!=null){
                    ...
                    //   height: 18,
                    // ),
                    //   AppText(title: "District",fontFamily: AppFontfamily.poppinsSemibold,),
                    // const SizedBox(
                    //   height: 10,
                    // ),
                    // CustomSearchDropDown(

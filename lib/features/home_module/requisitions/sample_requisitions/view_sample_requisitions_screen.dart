...
class ViewSampleRequisitionsScreen extends StatefulWidget {
  const ViewSampleRequisitionsScreen({super.key});

  @override
  State<ViewSampleRequisitionsScreen> createState() => _ViewSampleRequisitionsScreenState();
}

class _ViewSampleRequisitionsScreenState extends State<ViewSampleRequisitionsScreen> {
  
  @override
  Widget build(BuildContext context) {
    return Scaffold(   appBar: customAppBar(title: "Sample #124"),
      ...
      child: Column(
        children: [
          ...
          dotteDivierWidget(dividerColor: AppColors.edColor,),
            ...
            itemsWidget('Item 1', 'KG'),
            const SizedBox(height: 15,),
            itemsWidget('Item 2', '1'),
            const SizedBox(height: 15,),
            itemsWidget('Item 3', '1'),
            const SizedBox(height: 15,),
            itemsWidget('Item 4', '1'),
        ],
      ),
   );
  }

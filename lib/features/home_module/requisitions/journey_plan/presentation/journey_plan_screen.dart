      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            JourneyApprovedWidget(title: "Ticket #12345",):JourneyPendingWidget(
              title: "Ticket #12345",
              onTap: (){
              AppRouter.pushCupertinoNavigation(const ViewJourneyPlanScreen());
            },)
            )
          ],
        ),
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          customRadioButton(isSelected:selectedRadio==0? true:false, title: 'Air',
                          onTap: (){
                            state(() {
                              selectedRadio=0;
                            });
                          ...
                          customRadioButton(isSelected:selectedRadio==1? true:false, title: 'Land',
                          onTap: (){
                            state(() {
                              selectedRadio=1;
                            });

...
class MarkingPendingWidget extends StatelessWidget {
  final CollateralsRequestState refState;
   final CollateralsRequestNotifier refNotifier;
   ScrollController scrollController;
   MarkingPendingWidget({required this.refState, required this.refNotifier, required this.scrollController});
  ...
  Widget build(BuildContext context) {
    ...
    }): NoDataFound(title: "No pending marking collaterals found");
  }

...
class _KycScreenState extends ConsumerState<KycScreen> {
  ...
  Widget approvedKycWidget(
      {required KycState refState, required KycNotifier refNotifier}) {
    return refState.isLoading
        ...
        : (refState.kycModel?.data?[0].records?.length ?? 0) > 0
            ? ListView.separated(
                ...
                padding:
                    EdgeInsets.only(top: 10, bottom: 20, left: 18, right: 18),
                shrinkWrap: true,
                  ...
                  return GestureDetector(
                    ...
                    child: Column(
                      children: [
                        ...
                        index ==
                                    (refState.kycModel?.data?[0].records
                                                ?.length ??
                                            0) -
                                        1 &&
            ...
            : NoDataFound(
                title:
                    "No ${refState.tabBarIndex == 0 ? "approved" : "pending"} KYC found.");
  }
  ...
  filterBottomSheet(
      BuildContext context, KycNotifier refNotifier, KycState refState) {
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: Row(
                              children: List.generate(
                                  AppConstants.businessList.length, (val) {
                            return Padding(
                              ...
                              child: customRadioButton(
                                  isSelected: selectedBusinessTypeIndex == val
                                      ? true
                                      : false,
                                  title: AppConstants.businessList[val],
                                  onTap: () {
                                    setState(() {
                                      state(() {
                                        selectedBusinessTypeIndex = val;
                                        filterBusinessType =
                                            AppConstants.businessList[val];
                                      });
                                    });
                                  }),
                            );
                        ...
                        SingleChildScrollView(
                          ...
                          child: Row(
                              children: List.generate(
                                  AppConstants.customerCategoryList.length,
                                  (val) {
                            return Padding(
                              padding:
                                  const EdgeInsets.symmetric(horizontal: 10),
                              child: customRadioButton(
                                  isSelected: selectedCategoryTypeIndex == val
                                      ? true
                                      : false,
                                  title: AppConstants.customerCategoryList[val],
                                  onTap: () {
                                    setState(() {
                                      state(() {
                                        selectedCategoryTypeIndex = val;
                                        filterCategoryType = AppConstants
                                            .customerCategoryList[val];
                                      });
                                    });
                                  }),
                            );
                        ...
                        Align(
                          ...
                          child: AppTextButton(
                            ...
                            onTap: () {
                              if (filterCustomerType.isEmpty &&
                                  filterBusinessType.isEmpty &&
                                  filterSegmentType.isEmpty &&
                                  filterCategoryType.isEmpty) {
  ...
  Widget selectedFiltersWidget(
    ...
    return SingleChildScrollView(
      ...
      child: Row(
        // crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          refNotifier.customerTypeFilter.isNotEmpty
              ? customFiltersUI(refNotifier.customerTypeFilter, () {
          ...
          refNotifier.businessTypeFilter.isNotEmpty
              ...
              : EmptyWidget(),
          refNotifier.segmentFilter.isNotEmpty
              ? customFiltersUI(refNotifier.segmentFilter, () {
              ...
              : EmptyWidget(),
          refNotifier.customerCategoryFilter.isNotEmpty
              ? customFiltersUI(refNotifier.customerCategoryFilter, () {
  ...
  Widget _customerTypeFilters(state) {
    return Padding(
      padding: const EdgeInsets.symmetric(horizontal: 20),
      child: Column(
        children: [
          Row(
            children: [
              Padding(
                padding: const EdgeInsets.symmetric(horizontal: 10),
                child: customRadioButton(
                    isSelected: selectedCustomerTypeIndex == 0 ? true : false,
                    title: AppConstants.companyTypeList[0],
                    onTap: () {
                      setState(() {
                        state(() {
                          selectedCustomerTypeIndex = 0;
                          filterCustomerType = AppConstants.companyTypeList[0];
                        });
                      });
                    }),
              ),
              Padding(
                padding: const EdgeInsets.symmetric(horizontal: 10),
                child: customRadioButton(
                    isSelected: selectedCustomerTypeIndex == 1 ? true : false,
                    title: AppConstants.companyTypeList[1],
                    onTap: () {
                      setState(() {
                        state(() {
                          selectedCustomerTypeIndex = 1;
                          filterCustomerType = AppConstants.companyTypeList[1];
                        });
                      });
                    }),
              )
          ...
          Padding(
            padding: const EdgeInsets.symmetric(horizontal: 10),
            child: customRadioButton(
                isSelected: selectedCustomerTypeIndex == 2 ? true : false,
                title: AppConstants.companyTypeList[2],
                onTap: () {
                  setState(() {
                    state(() {
                      selectedCustomerTypeIndex = 2;
                      filterCustomerType = AppConstants.companyTypeList[2];
                    });
                  });
                }),
          ),
  ...
  Widget _segmentTypeFilters(state) {
    return Padding(
      padding: const EdgeInsets.symmetric(horizontal: 20),
      child: Column(
        children: [
          Row(
            children: [
              Padding(
                padding: const EdgeInsets.symmetric(horizontal: 10),
                child: customRadioButton(
                    isSelected: selectedSegmentTypeIndex == 0 ? true : false,
                    title: AppConstants.segmentList[0],
                    onTap: () {
                      setState(() {
                        state(() {
                          selectedSegmentTypeIndex = 0;
                          filterSegmentType = AppConstants.segmentList[0];
                        });
                      });
                    }),
              ),
              Padding(
                padding: const EdgeInsets.symmetric(horizontal: 10),
                child: customRadioButton(
                    isSelected: selectedSegmentTypeIndex == 1 ? true : false,
                    title: AppConstants.segmentList[1],
                    onTap: () {
                      setState(() {
                        state(() {
                          selectedSegmentTypeIndex = 1;
                          filterSegmentType = AppConstants.segmentList[1];
                        });
                      });
                    }),
              )
          ...
          Padding(
            padding: const EdgeInsets.symmetric(horizontal: 10),
            child: customRadioButton(
                isSelected: selectedSegmentTypeIndex == 2 ? true : false,
                title: AppConstants.segmentList[2],
                onTap: () {
                  setState(() {
                    state(() {
                      selectedSegmentTypeIndex = 2;
                      filterSegmentType = AppConstants.segmentList[2];
                    });
                  });
                }),
          )
